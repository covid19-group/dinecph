      ...
      <main className="flex-auto px-3 pt-16 pb-24">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="max-w-xl text-navy-light text-lg sm:text-xl mb-8">
            Dine lokale spisesteder er ramt af den nuværende krise—men de laver
            stadig mad! Hjælp dem til at forblive åbne ved at købe take-away fra
            de bedste restauranter i København.
          </p>
          <div className="-m-2">
            <Link href="/map">
